...
const float MAX_TWIST = 3.25f ;//2.f * M_PI
const float NEXT_TWIST_STEP = 0.1f;
const float TWIST_CHANGE_SPEED = 1.5f;
}
...
bool CTwistValueController::OnKeyDown(const SDL_KeyboardEvent &event)
{
    ...
    case SDLK_MINUS:
        ...
        return true;
	case SDLK_COMMA:
		m_nextTwistValue = MIN_TWIST;
		return true;
	case SDLK_PERIOD:
		m_nextTwistValue = MAX_TWIST;
		return true;
    default:
        return false;
    }
